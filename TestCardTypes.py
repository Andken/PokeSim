...
class TestCardTypes(unittest.TestCase):
    def test_isWaterType(self):
        ...
        self.assertEqual(ct.RandomReceiver().isWaterType(), False)
    ...
    def test_name(self):
        ...
        self.assertEqual(ct.RandomReceiver().name(), "Random Receiver")
    ...
    def test_isPokemon(self):
        ...
        self.assertEqual(isinstance(ct.RandomReceiver(), ct.Pokemon), False)
    ...
    def test_isTrainer(self):
        ...
        self.assertEqual(isinstance(ct.RandomReceiver(), ct.Trainer), True)
    ...
    def test_isSupporter(self):
        ...
        self.assertEqual(isinstance(ct.RandomReceiver(), ct.Supporter), False)
